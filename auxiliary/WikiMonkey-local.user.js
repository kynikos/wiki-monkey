...
WM.main({
    ...
    "Bot": [
        ["SimpleReplace", "RegExp substitution", ["1"]],
        ["FixBacklinkFragments", "Fix links to specific sections of a " +
                            "target page", "fix links to specific sections"],
        ["SynchronizeInterlanguageLinks", "Synchronize interlanguage links",
         "synchronized interlanguage links with the other wikis"],
        ["ArchWikiUpdatePackageTemplates", "Check packages linked with " +
                "Pkg/AUR templates and possibly update them",
