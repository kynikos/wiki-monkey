...
require('./modules/libs').init()
const {h: hh} = require('./modules/libs')

const {upgradePeriodical} = require('./modules/Upgrade')
...
const ArchWiki = require('./modules/ArchWiki')
...
const Interlanguage = require('./modules/Interlanguage')
const MW = require('./modules/MW')
const Parser = require('./modules/Parser')
const Tables = require('./modules/Tables')
const WhatLinksHere = require('./modules/WhatLinksHere')
