...
WM.UI.setSpecial([
    [
        ["UpdateCategoryTree", "Update main ToC",
         [{"Table of Contents": ["Category:English", "en", "*"],
           "Table of Contents (Français)": ["Category:Français", "fr", "#"],
           "Table of Contents (Indonesia)": ["Category:Indonesia", "en", "#"],
           "Table of Contents (Italiano)": ["Category:Italiano", "it", "#"],
           "Table of Contents (Magyar)": ["Category:Magyar", "en", "#"],
           "Table of Contents (Polski)": ["Category:Polski", "en", "#"],
           "Table of Contents (Slovenský)": ["Category:Slovenský", "en", "#"],
           "Table of Contents (Suomi)": ["Category:Suomi", "en", "#"],
           "Table of Contents (Svenska)": ["Category:Svenska", "en", "#"],
           "Table of Contents (Türkçe)": ["Category:Türkçe", "en", "#"],
           "Table of Contents (Ελληνικά)": ["Category:Ελληνικά", "en", "#"],
           "Table of Contents (Български)": ["Category:Български", "en", "#"],
           "Table of Contents (Српски)": ["Category:Српски", "en", "#"],
           // rtl scripts create buggy output
           //"Table of Contents (עברית)": ["Category:עברית", "en", "#"],
           "Table of Contents (ไทย)": ["Category:ไทย", "en", "#"],
           "Table of Contents (日本語)": ["Category:日本語", "en", "#"]},
