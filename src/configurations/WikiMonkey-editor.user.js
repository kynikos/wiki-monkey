...
if (document.getElementById("WikiMonkey")) {
    ...
    item.innerHTML += '<a href="https://raw.github.com/kynikos/wiki-monkey/master/src/configurations/WikiMonkey-archwikieditor.user.js">the "archwikieditor" configuration</a>';
    list.appendChild(item);
    item = document.createElement('li');
    item.innerHTML = 'uninstall the current "editor" configuration in Firefox\'s ';
    item.innerHTML += '"Add-ons Manager" -> "User Scripts"';
    list.appendChild(item);
    item = document.createElement('li');
    item.innerHTML = 're-enable the automatic updates for "archwikieditor" if you were using them before';
    list.appendChild(item);
