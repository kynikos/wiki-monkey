...
ref = module.exports.ArchWikiOldAURLinks = (function() {
  class ArchWikiOldAURLinks extends Plugin {
    constructor() {
      super(...arguments);
  ...
  //       unusable
  ArchWikiOldAURLinks.conf_default = {
    editor_menu: ["Query plugins", "Fix old AUR links"],
    option_label: "Replace old-style direct AUR package links with Template:AUR",
